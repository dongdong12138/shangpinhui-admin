<template>
  <div>
    ...
    <el-table v-loading="listLoading" border stripe style="width: 960px" :data="roles" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" width="300" align="center">
        <template v-slot="{row}">
          ...
          <HintButton v-if="row.edit" size="mini" type="primary" icon="el-icon-check" title="确定" @click="updateRole(row)" />
          <HintButton v-if="!row.edit" size="mini" type="primary" icon="el-icon-edit" title="修改角色" @click="row.edit = true" />
