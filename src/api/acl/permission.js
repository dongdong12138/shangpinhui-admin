...
权限管理相关的API请求函数
*/
const api_name = '/dev-api1/admin/acl/permission'
...
export default {
  ...
  */
  updatePermission(permission) {
    return request({ url: `${api_name}/update`, method: 'put', data: permission })
  },
  ...
  */
  doAssign(roleId, permissionId) {
    return request({ url: `${api_name}/doAssign`, method: 'post', params: { roleId, permissionId }})
  }
}
